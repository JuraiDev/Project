...
class ModuleUpdater:
    ...
    def update_module(self, module_name, update_function, *args, **kwargs):
        if module_name in self.modules:
            module = importlib.import_module(self.modules[module_name].replace(".py", ""))
            update_function(module, *args, **kwargs)
        else:
            print(f"Module {module_name} not found.")

    def handle_player_input(self, player_input):
        self.multiplayer_manager.handle_player_input(player_input)
